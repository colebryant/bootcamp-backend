    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-0ILPN6E\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;";
        ...
        public void AddDepartment(Department department)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = "INSERT INTO Department (DeptName) Values (@departmentName)";
        ...
        public Employee GetEmployeeById(int id)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    cmd.CommandText = $"SELECT Id, FirstName, LastName, DepartmentId FROM Employee WHERE Id = @employeeId";
